...
import { planetsGetAllData } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/funcs/planetsGetAllData.js";
...
async function run() {
  const res = await planetsGetAllData(demoApiScalarGalaxy, {});
  if (res.ok) {
...
async function run() {
  const result = await demoApiScalarGalaxy.planets.createPlanetJson({
    name: "Mars",
...
```typescript
import { DemoApiScalarGalaxyCore } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/core.js";
import { planetsCreatePlanetJson } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/funcs/planetsCreatePlanetJson.js";
...
async function run() {
  const res = await planetsCreatePlanetJson(demoApiScalarGalaxy, {
    name: "Mars",
    description: "The red planet",
    type: "terrestrial",
    habitabilityIndex: 0.68,
...
async function run() {
  const result = await demoApiScalarGalaxy.planets.createPlanetRaw(bytesToStream(new TextEncoder().encode("{\"name\":\"Mars\",\"description\":\"The red planet\",\"type\":\"terrestrial\",\"habitabilityIndex\":0.68,\"physicalProperties\":{\"mass\":0.107,\"radius\":0.532,\"gravity\":0.378,\"temperature\":{\"min\":130,\"max\":308,\"average\":210}},\"atmosphere\":[{\"compound\":\"CO2\",\"percentage\":95.3}],\"discoveredAt\":\"1610-01-07T00:00:00Z\",\"image\":\"https://cdn.scalar.com/photos/mars.jpg\",\"satellites\":[{\"name\":\"Phobos\",\"description\":\"Phobos is the larger and innermost of the two moons of Mars.\",\"diameter\":22.2,\"type\":\"moon\",\"orbit\":{\"planetId\":1,\"orbitalPeriod\":0.319,\"distance\":9376}}],\"creator\":{\"name\":\"Marc\"},\"tags\":[\"solar-system\",\"rocky\",\"explored\"],\"successCallbackUrl\":\"https://example.com/webhook\",\"failureCallbackUrl\":\"https://example.com/webhook\"}")));
...
```typescript
import { DemoApiScalarGalaxyCore } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/core.js";
import { planetsCreatePlanetRaw } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/funcs/planetsCreatePlanetRaw.js";
...
async function run() {
  const res = await planetsCreatePlanetRaw(demoApiScalarGalaxy, bytesToStream(new TextEncoder().encode("{\"name\":\"Mars\",\"description\":\"The red planet\",\"type\":\"terrestrial\",\"habitabilityIndex\":0.68,\"physicalProperties\":{\"mass\":0.107,\"radius\":0.532,\"gravity\":0.378,\"temperature\":{\"min\":130,\"max\":308,\"average\":210}},\"atmosphere\":[{\"compound\":\"CO2\",\"percentage\":95.3}],\"discoveredAt\":\"1610-01-07T00:00:00Z\",\"image\":\"https://cdn.scalar.com/photos/mars.jpg\",\"satellites\":[{\"name\":\"Phobos\",\"description\":\"Phobos is the larger and innermost of the two moons of Mars.\",\"diameter\":22.2,\"type\":\"moon\",\"orbit\":{\"planetId\":1,\"orbitalPeriod\":0.319,\"distance\":9376}}],\"creator\":{\"name\":\"Marc\"},\"tags\":[\"solar-system\",\"rocky\",\"explored\"],\"successCallbackUrl\":\"https://example.com/webhook\",\"failureCallbackUrl\":\"https://example.com/webhook\"}")));
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await demoApiScalarGalaxy.planets.getPlanet({
    planetId: 1,
  });
...
```typescript
import { DemoApiScalarGalaxyCore } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/core.js";
import { planetsGetPlanet } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/funcs/planetsGetPlanet.js";
...
async function run() {
  const res = await planetsGetPlanet(demoApiScalarGalaxy, {
    planetId: 1,
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await demoApiScalarGalaxy.planets.updatePlanetJson({
    planetId: 1,
    planet: {
      name: "Mars",
      description: "The red planet",
...
```typescript
import { DemoApiScalarGalaxyCore } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/core.js";
import { planetsUpdatePlanetJson } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/funcs/planetsUpdatePlanetJson.js";
...
async function run() {
  const res = await planetsUpdatePlanetJson(demoApiScalarGalaxy, {
    planetId: 1,
    planet: {
      name: "Mars",
      description: "The red planet",
...
async function run() {
  const result = await demoApiScalarGalaxy.planets.updatePlanetRaw({
    planetId: 1,
...
```typescript
import { DemoApiScalarGalaxyCore } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/core.js";
import { planetsUpdatePlanetRaw } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/funcs/planetsUpdatePlanetRaw.js";
...
async function run() {
  const res = await planetsUpdatePlanetRaw(demoApiScalarGalaxy, {
    planetId: 1,
    planet: bytesToStream(new TextEncoder().encode("{\"name\":\"Mars\",\"description\":\"The red planet\",\"type\":\"terrestrial\",\"habitabilityIndex\":0.68,\"physicalProperties\":{\"mass\":0.107,\"radius\":0.532,\"gravity\":0.378,\"temperature\":{\"min\":130,\"max\":308,\"average\":210}},\"atmosphere\":[{\"compound\":\"CO2\",\"percentage\":95.3}],\"discoveredAt\":\"1610-01-07T00:00:00Z\",\"image\":\"https://cdn.scalar.com/photos/mars.jpg\",\"satellites\":[{\"name\":\"Phobos\",\"description\":\"Phobos is the larger and innermost of the two moons of Mars.\",\"diameter\":22.2,\"type\":\"moon\",\"orbit\":{\"planetId\":1,\"orbitalPeriod\":0.319,\"distance\":9376}}],\"creator\":{\"name\":\"Marc\"},\"tags\":[\"solar-system\",\"rocky\",\"explored\"],\"successCallbackUrl\":\"https://example.com/webhook\",\"failureCallbackUrl\":\"https://example.com/webhook\"}")),
  });
  if (res.ok) {
...
async function run() {
  await demoApiScalarGalaxy.planets.deletePlanet({
    planetId: 1,
  });
...
```typescript
import { DemoApiScalarGalaxyCore } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/core.js";
import { planetsDeletePlanet } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/funcs/planetsDeletePlanet.js";
...
async function run() {
  const res = await planetsDeletePlanet(demoApiScalarGalaxy, {
    planetId: 1,
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await demoApiScalarGalaxy.planets.uploadImage({
    planetId: 1,
    requestBody: {
...
```typescript
import { DemoApiScalarGalaxyCore } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/core.js";
import { planetsUploadImage } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/funcs/planetsUploadImage.js";
import { openAsBlob } from "node:fs";
...
async function run() {
  const res = await planetsUploadImage(demoApiScalarGalaxy, {
    planetId: 1,
    requestBody: {
      image: await openAsBlob("example.file"),
    },
