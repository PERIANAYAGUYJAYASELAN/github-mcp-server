...
export type Planet = {
   ...
   */
  failureCallbackUrl?: string | undefined;
};
...
export type Planet1 = {
   ...
   */
  habitabilityIndex?: number | undefined;
  physicalProperties?: { [k: string]: number } | undefined;
  /**
   * Atmospheric composition
   */
  atmosphere?: Array<{ [k: string]: string }> | undefined;
  discoveredAt?: Date | undefined;
  image?: string | null | undefined;
  satellites?: Array<Satellite> | undefined;
  /**
...
export type PlanetInput = {
  ...
  discoveredAt?: Date | undefined;
  image?: string | null | undefined;
  satellites?: Array<SatelliteInput> | undefined;
  /**
   * A user
   */
...
> = z.object({
  ...
  max: z.number().optional(),
  average: z.number().optional(),
  additionalProperties: z.record(z.number()),
}).transform((v) => {
  return {
...
/** @internal */
export const Planet1$inboundSchema: z.ZodType<Planet1, z.ZodTypeDef, unknown> =
  z.object({
    id: z.number().int(),
    name: z.string(),
    description: z.nullable(z.string()).optional(),
    type: Type$inboundSchema,
    habitabilityIndex: z.number().optional(),
    physicalProperties: z.record(z.number()).optional(),
    atmosphere: z.array(z.record(z.string())).optional(),
    discoveredAt: z.string().datetime({ offset: true }).transform(v =>
      new Date(v)
    ).optional(),
    image: z.nullable(z.string()).optional(),
...
/** @internal */
export const Planet1$outboundSchema: z.ZodType<
  Planet1$Outbound,
  z.ZodTypeDef,
  Planet1
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace Planet1$ {
  /** @deprecated use `Planet1$inboundSchema` instead. */
  export const inboundSchema = Planet1$inboundSchema;
  /** @deprecated use `Planet1$outboundSchema` instead. */
  export const outboundSchema = Planet1$outboundSchema;
  /** @deprecated use `Planet1$Outbound` instead. */
  export type Outbound = Planet1$Outbound;
}

export function planet1ToJSON(planet1: Planet1): string {
  return JSON.stringify(Planet1$outboundSchema.parse(planet1));
}

export function planet1FromJSON(
  jsonString: string,
): SafeParseResult<Planet1, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => Planet1$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Planet1' from JSON`,
  );
}
...
> = z.object({
  ...
  image: z.nullable(z.string()).optional(),
  satellites: z.array(SatelliteInput$inboundSchema).optional(),
...
export type PlanetInput$Outbound = {
  ...
  discoveredAt?: string | undefined;
  image?: string | null | undefined;
  satellites?: Array<SatelliteInput$Outbound> | undefined;
...
> = z.object({
  ...
  discoveredAt: z.date().transform(v => v.toISOString()).optional(),
  image: z.nullable(z.string()).optional(),
  satellites: z.array(SatelliteInput$outboundSchema).optional(),
