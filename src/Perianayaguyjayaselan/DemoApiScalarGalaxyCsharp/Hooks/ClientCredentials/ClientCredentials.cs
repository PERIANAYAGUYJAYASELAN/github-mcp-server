...
namespace Perianayaguyjayaselan.DemoApiScalarGalaxyCsharp.Hooks.ClientCredentials
{
    ...
    public class ClientCredentialsHook : ISDKInitHook, IBeforeRequestHook, IAfterErrorHook
    {
        ...
        private Credentials? GetCredentialsGlobal(Func<object> securitySource)
        {
            ...
            if (security?.OAuth2?.ClientID == null || security?.OAuth2?.ClientSecret == null || security?.OAuth2?.TokenURL == null)
            {
                return null;
            }
