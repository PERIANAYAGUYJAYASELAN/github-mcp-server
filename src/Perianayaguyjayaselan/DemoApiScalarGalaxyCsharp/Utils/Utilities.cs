...
//------------------------------------------------------------------------------
#nullable enable
namespace Perianayaguyjayaselan.DemoApiScalarGalaxyCsharp.Utils
{
    using System;
    using System.Linq;
    ...
    public class Utilities
    {
        ...
        public static bool IsClass(object? o)
        {
            if (o == null)
                return false;
            return o.GetType().IsClass && (o.GetType().FullName ?? "").StartsWith("Perianayaguyjayaselan.DemoApiScalarGalaxyCsharp.Models");
        }
