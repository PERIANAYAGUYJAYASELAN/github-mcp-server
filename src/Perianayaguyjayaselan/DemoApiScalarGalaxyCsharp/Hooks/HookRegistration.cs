...
namespace Perianayaguyjayaselan.DemoApiScalarGalaxyCsharp.Hooks
{
    /// <summary>
    ...
    public static class HookRegistration
    {
        ...
        /// </summary>
        /// <remarks>
        /// Add hooks by calling `Perianayaguyjayaselan.DemoApiScalarGalaxyCsharp.Hooks.Register&lt;HookInterface&gt;(myHook);`
