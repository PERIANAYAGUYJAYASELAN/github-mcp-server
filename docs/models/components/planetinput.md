...
```typescript
import { PlanetInput } from "@perianayaguyjayaselan/demo-api-scalar-galaxy-typescript/models/components";
...
| `satellites`                                                                                  | [components.SatelliteInput](../../models/components/satelliteinput.md)[]                      | :heavy_minus_sign:                                                                            | N/A                                                                                           |                                                                                               |
